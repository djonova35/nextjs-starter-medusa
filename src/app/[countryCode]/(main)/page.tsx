        ...
        <div className="container">
          <div className="stats-grid">
            <div className="stat-item fade-up fade-up-1">
              <div className="stat-num">40<span>K+</span></div>
      ...
      <footer className="footer">
        <div className="container">
          <div className="footer-top">
            <div className="footer-brand">
              ...
              <p className="footer-desc">
                Crafted for those who move with intention. DJONOVA is where couture
                meets everyday wearability.
              </p>
          ...
          <div className="footer-bottom">
            <div className="footer-copy">© 2026 DJONOVA. All rights reserved.</div>
