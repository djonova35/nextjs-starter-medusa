        ...
        <div className="hidden small:block border-t border-ui-border-base">
          <div className="content-container flex items-center justify-center gap-x-8 h-10">
            ...
            <div className="relative group/cat">
              <LocalizedClientLink href="/categories/fashion" className="text-xs uppercase tracking-widest text-ui-fg-subtle hover:text-ui-fg-base transition-colors py-2 inline-block">
                Fashion
              </LocalizedClientLink>
            ...
            {/* SHOES */}
            <div className="relative group/cat">
              <LocalizedClientLink href="/categories/shoes" className="text-xs uppercase tracking-widest text-ui-fg-subtle hover:text-ui-fg-base transition-colors py-2 inline-block">
                Shoes
              </LocalizedClientLink>
              <div className="absolute top-full left-1/2 -translate-x-1/2 bg-white border border-ui-border-base shadow-lg opacity-0 invisible group-hover/cat:opacity-100 group-hover/cat:visible transition-all duration-200 z-50 min-w-[160px]">
            ...
            {/* TECH */}
            <div className="relative group/cat">
              <LocalizedClientLink href="/categories/tech" className="text-xs uppercase tracking-widest text-ui-fg-subtle hover:text-ui-fg-base transition-colors py-2 inline-block">
                Tech
              </LocalizedClientLink>
              <div className="absolute top-full left-1/2 -translate-x-1/2 bg-white border border-ui-border-base shadow-lg opacity-0 invisible group-hover/cat:opacity-100 group-hover/cat:visible transition-all duration-200 z-50 min-w-[160px]">
            ...
            {/* ALL PRODUCTS */}
            <LocalizedClientLink href="/store" className="text-xs uppercase tracking-widest text-ui-fg-subtle hover:text-ui-fg-base transition-colors py-2 inline-block">
              All Products
            </LocalizedClientLink>
